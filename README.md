...
<details>
  <summary><strong>13. Síntesis e interpretación sustantiva</strong></summary>

## 13. Síntesis e interpretación sustantiva

El objetivo central de este estudio fue **evaluar en qué medida las variaciones comunales en la tasa de desempleo entre elecciones presidenciales (2010–2017) influyen en los cambios en el apoyo electoral a los candidatos de oposición.** Esta pregunta se inserta en la tradición del voto económico retrospectivo, según la cual los ciudadanos tienden a castigar o premiar al oficialismo según la evaluación de las condiciones económicas recientes. En un contexto chileno marcado por alternancia política y por transformaciones profundas del mercado laboral, cabía esperar que fluctuaciones locales del desempleo produjeran ajustes en las preferencias electorales. Sin embargo, como muestran los análisis descriptivos, gráficos y modelos multivariados, **la relación entre cambios en el desempleo y cambios en el voto opositor es sistemáticamente débil, irregular y, en última instancia, estadísticamente inexistente.**
...
En coherencia con la evidencia descriptiva, el análisis multivariado en primeras diferencias confirma que **la variación en el desempleo no tiene efectos estadísticamente significativos sobre el cambio en el voto a la oposición.** El coeficiente de Δ desempleo es cercano a cero y presenta valores p altos tanto en modelos simples como en modelos con efectos fijos por año y región. Las variables de control —densidad, población total y proporción femenina— tampoco muestran efectos robustos, salvo la densidad poblacional en el modelo con errores estándar agrupados, aunque este resultado no altera la conclusión general. **El aumento del R² en el modelo con efectos fijos (en torno a 0.40) está explicado casi íntegramente por diferencias entre ciclos electorales y no por la estructura comunal ni por el comportamiento económico local.**

Las pruebas de diagnóstico refuerzan la validez técnica del ejercicio. **Los valores VIF se encuentran prácticamente en 1, descartando multicolinealidad.** Los residuos presentan un comportamiento razonablemente normal y sin patrones que sugieran heterocedasticidad severa. La prueba de influencias confirma que los outliers detectados no modifican sustantivamente los coeficientes, lo cual da estabilidad a los resultados. A nivel cualitativo, incluso las comunas más extremas respecto a variaciones en el desempleo no exhiben cambios electorales coherentes con un patrón de voto económico retrospectivo.

En conjunto, **los resultados de todo el análisis apuntan en la misma dirección: entre 2010 y 2017, las comunas chilenas no cambiaron su apoyo a la oposición en función de las fluctuaciones locales del desempleo.** Más bien, los cambios electorales estuvieron fuertemente determinados por dinámicas nacionales, en especial por el desempeño electoral extraordinario de Bachelet en 2013 y por el retorno de la derecha en 2017. En otras palabras, los votantes parecen haber respondido más a identidades partidarias, tendencias nacionales, percepciones políticas generales o clima político nacional, que a condiciones económicas comunales específicas.

A partir de esta conclusión, surgen líneas de investigación futuras que podrían enriquecer el análisis. En primer lugar, extender el periodo temporal permitiría incluir más ciclos electorales, lo cual es clave para identificar patrones estables del voto económico. En segundo lugar, una variable central que no se incorporó por falta de datos completos —la ruralidad— podría modificar sustantivamente las conclusiones, dada la importancia creciente de las brechas urbano-rurales en la política chilena. Asimismo, sería recomendable complementar la tasa de desempleo con otros indicadores laborales, como subempleo, informalidad o ingresos reales, que podrían captar mejor la experiencia económica local. Finalmente, integrar encuestas nacionales o datos de percepción económica permitiría acercarnos a la lógica subjetiva del voto retrospectivo, que muchas veces opera no sobre datos económicos objetivos, sino sobre interpretaciones sociales del desempeño del gobierno.

En suma, **el análisis muestra que la economía local no fue un motor del cambio electoral entre 2010 y 2017.** Los votantes chilenos no ajustaron su apoyo a la oposición en función de las variaciones comunales en el desempleo, sino más bien respondieron a dinámicas políticas nacionales de mayor escala. Esta conclusión, si bien negativa respecto a la hipótesis inicial, aporta evidencia relevante para el estudio del voto económico en Chile y abre caminos metodológicos y teóricos para investigaciones futuras más amplias, profundas y comparativas.
